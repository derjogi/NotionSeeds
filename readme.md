...
[![Build Status](https://github.com/derjogi/NotionSeeds/actions/workflows/build.yml/badge.svg)](https://github.com/derjogi/NotionSeeds/actions/workflows/build.yml) [![Prettier Code Formatting](https://img.shields.io/badge/code_style-prettier-brightgreen.svg)](https://prettier.io)


## Fast start:

* Clone this repo: `git clone https://github.com/derjogi/NotionSeeds.git`
* Adjust site.config.ts
* Fill navigation.json with your links you want to be accessible
* Test it:
  * As Dev: `yarn && yarn run dev`
  * And as Build: `yarn run build && yarn run start`  (... yes, it is important to test it as build as well, it runs some different steps and does different analysing, and it will do some caching and stuff and be much faster!)
* Deploy: `yarn run deploy`
* Enjoy 🎉

## Intro
This repo is forked from transitivebullsh.it, credit should go to them:

>This is what I use to power my personal blog and portfolio site [transitivebullsh.it](https://transitivebullsh.it).
...
All commands can be run with NPM or with Yarn, it is up to you. (Just avoid mixing them!)
